      ...
      {activeModal === 'hackathon' && (
        <HackathonModal
          ...
          initialHackathon={parsedData ? {
            ...
            registrationDeadline: parsedData.registrationDeadline || parsedData.submissionDeadline || parsedData.dueDate || '',
            submissionDeadline: parsedData.submissionDeadline || parsedData.registrationDeadline || parsedData.dueDate || '',
      ...
      {activeModal === 'internship' && (
        <InternshipModal
          ...
          initialInternship={parsedData ? {
            ...
            deadlineDate: parsedData.deadlineDate || parsedData.dueDate || '',
