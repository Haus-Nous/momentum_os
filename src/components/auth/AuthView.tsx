...
export const AuthView: React.FC = ({ isAuthLoading }: { isAuthLoading: boolean }) => {
		...
		<div className="min-h-screen w-screen bg-[#07090e] flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-emerald-500/30 selection:text-emerald-400">
			...
			>
				...
				<div className="flex flex-col items-center text-center mb-8">
					...
					{isAuthLoading ? (
						<p className="text-sm text-slate-400 mt-1">Authenticating your account...</p>
					) : (
						<p className="text-sm text-slate-400 mt-1">Personal Execution System & Operating Environment</p>
					)}
				</div>
						...
						<form onSubmit={handleSubmit} className="space-y-4">
								...
								>
									...
									<div>
										...
										<div className="relative">
											...
											>
												<option value="professional" className="bg-slate-900 text-slate-100">
													Professional / Industry
												</option>
												<option value="academic" className="bg-slate-900 text-slate-100">
													Student / Academic
												</option>
												<option value="creative" className="bg-slate-900 text-slate-100">
													Creative / Freelancer
												</option>
											</select>
										</div>
							...
							>
								{isLoading ? (
									...
									<>
										<span>
											{mode === "login" ? "Log In to Workspace" : "Initialize Personal OS"}
										</span>
