    ...
    <header className="h-16 border-b border-[#E2DACD] dark:border-[#332F2B] bg-[#F3EFE6] dark:bg-[#1C1A18] sticky top-0 z-30 px-3 md:px-6 flex items-center justify-between transition-colors">
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        <button
          ...
          className="flex items-center space-x-1.5 sm:space-x-2.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 border border-black/5 dark:border-white/5 text-gray-500 text-xs transition-colors cursor-pointer"
          title="Search or Command"
        >
        ...
        <button
          ...
          className="flex items-center space-x-1.5 px-2.5 sm:px-3.5 py-1.5 rounded-xl bg-[#D85A2A] hover:bg-[#C44E20] dark:bg-[#E56B3A] dark:hover:bg-[#D85A2A] text-white text-xs font-bold transition-all shadow-sm cursor-pointer"
          title="AI Assistant"
        >
        ...
        <button
          ...
          className={`flex items-center space-x-1 px-2 py-1.5 rounded-xl text-xs font-semibold border transition-all cursor-pointer ${
      ...
      <div className="flex items-center space-x-1.5 sm:space-x-3">
        ...
        <div className="flex items-center space-x-1">
          <div className="flex items-center space-x-1 bg-[#D9A05B]/10 border border-[#D9A05B]/20 px-2 py-1 rounded-xl text-[#D9A05B] dark:text-[#E5B574] font-mono text-xs font-bold" title="Active Daily Streak">
            <Flame className="w-3.5 h-3.5 fill-[#D9A05B] dark:fill-[#E5B574]" />
            <span>{profile.streakDays}d</span>
          </div>

          <div className="hidden sm:flex items-center space-x-1 bg-[#78899A]/10 border border-[#78899A]/20 px-2 py-1 rounded-xl text-[#78899A] dark:text-[#90A2B4] font-mono text-xs font-bold" title="Streak Freeze Tokens (Max 3)">
            <span>🧊</span>
